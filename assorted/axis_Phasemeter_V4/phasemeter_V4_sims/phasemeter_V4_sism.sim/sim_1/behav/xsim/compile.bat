...
REM
REM Generated by Vivado on Mon Dec 12 19:19:18 +0800 2022
...
echo "xvlog --incr --relax -prj CIC_TB_vlog.prj"
call xvlog  --incr --relax -prj CIC_TB_vlog.prj -log xvlog.log
