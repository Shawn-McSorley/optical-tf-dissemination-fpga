...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NCO_V4 is
  ...
  signal \DITHER_BLOCK_GEN.PRN_SHIFT_REG\ : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \DITHER_BLOCK_GEN.PRN_SHIFT_REG[31]_i_2_n_0\ : STD_LOGIC;
...
\DITHER_BLOCK_GEN.PRN_SHIFT_REG[31]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\DITHER_BLOCK_GEN.PRN_SHIFT_REG[31]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\DITHER_BLOCK_GEN.PRN_SHIFT_REG_reg[31]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => p_0_in,
      CLR => rst,
