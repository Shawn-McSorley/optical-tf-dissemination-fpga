...
startgroup
create_bd_cell -type ip -vlnv shawn-mcSorley:user:axis_logger:1.1 axis_logger_0
set_property -dict [list CONFIG.DOWN_SAMPLE {5} CONFIG.DMA_BUFFER {139264} CONFIG.N_FIFO {40} CONFIG.c_sg_include_stscntrl_strm {0} CONFIG.c_include_sg {0}] [get_bd_cells axis_logger_0]
...
set_property CONFIG.FREQ_HZ 125000000 [get_bd_intf_pins /axis_logger_0/m_axis_S2MMS]
endgroup
...
connect_bd_intf_net [get_bd_intf_pins axis_logger_0/m_axis_S2MMS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
connect_bd_net [get_bd_pins axis_logger_0/m_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0]
connect_bd_net [get_bd_pins axis_logger_0/trigger] [get_bd_pins axi_gpio_0/gpio_io_i]
connect_bd_net [get_bd_pins axis_logger_0/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0]
