...
HD_PWD='Z:/Uni/ICRAR_Internship/Phasemeter/axis_NCO_V4/NCO_V4_Sims/NCO_V4_Sims.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NCO_V4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NCO_V4.tcl
