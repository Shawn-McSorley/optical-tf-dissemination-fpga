...
HD_PWD='Z:/Uni/ICRAR_Internship/Phasemeter/axis_NCO_V4/NCO_V4_Sims/NCO_V4_Sims.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NCO_V4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NCO_V4.tcl -notrace
