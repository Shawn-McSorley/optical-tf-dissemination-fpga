...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NCO_V4 is
  ...
  attribute HLUTNM of \ACCUMULATOR[23]_i_2\ : label is "lutpair1";
  attribute HLUTNM of \ACCUMULATOR[23]_i_3\ : label is "lutpair0";
  attribute HLUTNM of \ACCUMULATOR[23]_i_4\ : label is "lutpair3";
  attribute HLUTNM of \ACCUMULATOR[23]_i_6\ : label is "lutpair2";
  attribute HLUTNM of \ACCUMULATOR[23]_i_7\ : label is "lutpair1";
  attribute HLUTNM of \ACCUMULATOR[23]_i_8\ : label is "lutpair0";
  attribute HLUTNM of \ACCUMULATOR[23]_i_9\ : label is "lutpair3";
  attribute HLUTNM of \ACCUMULATOR[27]_i_5\ : label is "lutpair2";
...
\ACCUMULATOR[19]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\ACCUMULATOR[19]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\ACCUMULATOR[19]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\ACCUMULATOR[19]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\ACCUMULATOR[23]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\ACCUMULATOR[23]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
