...
HD_PWD='Z:/Uni/ICRAR_Internship/Phasemeter/axis_NCO_V4/NCO_V4_Project/tmp/project/project.runs/system_NCO_V4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_NCO_V4_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_NCO_V4_0_0.tcl
